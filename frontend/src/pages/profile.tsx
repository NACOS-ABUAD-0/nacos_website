...
//             <div className="bg-yellow-50 border-l-4 border-yellow-400 rounded-lg p-4 shadow-sm mb-6">
      ...
      <main className="flex-grow">
        <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600">
              Manage your personal information and showcase your identity in the
              NACOS community
            </p>
          </div>
            ...
            <div className="px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Your profile helps the community recognize your
                    contributions
                  </p>
                </div>
                <button
            ...
            <div className="mt-6 bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-lg">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-700 mt-1">
                    Add more details to your profile to showcase your skills and
                    connect with opportunities in the community.
                  </p>
                </div>
              </div>
            </div>
