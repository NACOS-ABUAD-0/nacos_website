...
const fadeUpVariant: Variants = {
  ...
  visible: (delay: number = 0) => ({
    opacity: 1,
    y: 0,
    transition: { duration: 0.65, ease: "easeInOut", delay },
  }),
};
...
const ctaVariant: Variants = {
  ...
  visible: {
    ...
    y: 0,
    scale: 1,
    transition: { duration: 0.55, ease: "easeInOut", delay: 0.45 },
  },
};
...
export const Section = forwardRef<HTMLElement, SectionProps>(
  ({ title, subtitle, children, ctaText, ctaLink, id }, ref) => {
