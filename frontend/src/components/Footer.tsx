...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-gradient-to-br from-green-600 to-emerald-700 text-white border-t border-green-700">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center mb-4">
              <div className="flex items-center space-x-3 bg-white/10 backdrop-blur-sm rounded-2xl px-4 py-3">
                <img
                  className="h-7 w-7 transition-transform hover:scale-110 duration-300"
                ...
                <img
                  ...
                  alt="NACOS Logo"
                />
                <span className="ml-1 font-bold text-lg tracking-tight">NACOS ABUAD</span>
              </div>
            </div>
            <p className="text-green-100 text-lg leading-relaxed max-w-md">
              Empowering the next generation of African tech innovators through collaboration and innovation.
            </p>
          </div>
        ...
        <div className="pt-8 border-t border-green-500/30">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="text-green-100 text-sm">
              &copy; {new Date().getFullYear()} NACOS ABUAD. All rights reserved.
            </div>
